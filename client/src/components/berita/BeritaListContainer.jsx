...
import BeritaToolbar from "./BeritaToolbar.jsx";
import BeritaTable from "./BeritaTable.jsx";
import BeritaGrid from "./BeritaGrid.jsx";
import PaginationControls from "../PaginationControls.jsx";
import BulkActions from "./BeritaBulkActions.jsx";
import ConfirmDialog from "../ui/ConfirmDialog.jsx";

export default function BeritaListContainer() {
  ...
  return (
    <div>
      ...
      <ConfirmDialog
        ...
        message={
          confirm.mode === "bulk"
            ? `Hapus ${selected.size} berita terpilih?`
