...
import AdministrasiToolbar from "./AdministrasiToolbar.jsx";
import AdministrasiTable from "./AdministrasiTable.jsx";
import PaginationControls from "../PaginationControls.jsx";
import AdministrasiBulkActions from "./AdminisrasiBulkActions.jsx";
import ConfirmDialog from "../ui/ConfirmDialog.jsx";
import AdministrasiDetailModal from "./AdministrasiDetailModal.jsx";

export default function AdministrasiListContainer() {
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-semibold">Layanan Administrasi</h1>
        <p className="text-gray-600 dark:text-gray-400">
          Permintaan layanan administrasi dari masyarakat
        </p>
      </div>
      ...
      {selected.size > 0 && (
        <AdministrasiBulkActions
          ...
          onReject={() => requestStatusChange("ditolak")}
        />
      )}
      ...
      <AdministrasiTable
        ...
        onReject={(id) => requestStatusChange("ditolak", id)}
      />
